...
extern "C" {
    ...
    // Usually the symbol generated by objcopy is _binary_xxx_yyy_start/end/size
    // the inicode is in target/x86_64-ros/debug/initcode, so the name is long
...
pub unsafe fn memmove<T>(dst: *mut T, src: *const T, len: usize) -> () {
